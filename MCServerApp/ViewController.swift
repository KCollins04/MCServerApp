...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        do{
            ...
            let imageData = Data(base64Encoded: serverData.favicon_base64 ?? defaultIcon)
    ...
    override func viewDidLoad() {
        ...
        addServerGlobal(Server(name: "test test ", ip: "mc.hypixel.net", bedrock: false))

        serverTableView.delegate = self
        serverTableView.dataSource = self
        
        addServerGlobal(Server(name: "test test test", ip: "us.mineplex.com", bedrock: false))
